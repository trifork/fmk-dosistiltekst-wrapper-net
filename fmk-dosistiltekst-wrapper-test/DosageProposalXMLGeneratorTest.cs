...
namespace fmk_dosistiltekst_wrapper_test
{
    public class DosageProposalXMLGeneratorTest : AbstractDosageWrapperTest
    {
        ...
        public void testBasicWithLongerShortText()
        {
            ...
            Assert.AreEqual("Doseringsforløbet starter onsdag den 17. maj 2017, gentages hver dag, og ophører torsdag den 1. juni 2017:\n" +
                    "   Doseringsforløb:\n" +
                    "   1 tablet efter behov højst 1 gang daglig, tages med rigeligt vand OG NOGET MERE SOM GØR DEN KORTE DOSERINGSTEKST NOGET LÆNGERE END DE SÆDVANLIGE 70 KARAKTERER", res.LongText);
            Assert.AreEqual("1 tablet efter behov, højst 1 gang daglig, tages med rigeligt vand OG NOGET MERE SOM GØR DEN KORTE DOSERINGSTEKST NOGET LÆNGERE END DE SÆDVANLIGE 70 KARAKTERER", res.ShortText);
        ...
        public void testMultiPeriode()
        {
            ...
            "   Doseringsforløb:\n" +
            "   2 tabletter 1 gang daglig tages med rigeligt vand", res.LongText);
        }
    }
}
