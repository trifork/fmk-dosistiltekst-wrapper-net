...
namespace fmk_dosistiltekst_wrapper_test
{
    ...
    public class DosageProposalTest: AbstractDosageWrapperTest
    {
	    ...
	    public void TestBasic() {
		    var res = DosisTilTekstWrapper.GetDosageProposalResult("PN", "1", "1", "tablet", "tabletter", ", tages med rigeligt vand", new [] { new DateTime(2017, 5, 17) }, new [] { new DateTime(2017, 6, 1) }, FMKVersion.FMK146, 1);
